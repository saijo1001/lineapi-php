      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem697 = null;
              $elem697 = new \ChannelNotificationSetting();
  ...
  public function write($output) {
    ...
    if ($this->channelIds !== null) {
      ...
      $xfer += $output->writeFieldBegin('channelIds', TType::LST, 1);
      {
        ...
        {
          foreach ($this->channelIds as $iter705)
          {
            $xfer += $output->writeString($iter705);
          }
        }
        $output->writeListEnd();
      }
  ...
  public function write($output) {
    ...
    if ($this->authScheme !== null) {
      ...
      $xfer += $output->writeFieldBegin('authScheme', TType::LST, 3);
      {
        ...
        {
          foreach ($this->authScheme as $iter712)
          {
      ...
      switch ($fid)
      {
        case 1:
          if ($ftype == TType::LST) {
            ...
            {
              $elem718 = null;
              $elem718 = new \ChannelNotificationSetting();
              $xfer += $elem718->read($input);
              $this->setting []= $elem718;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->setting !== null) {
      ...
      $xfer += $output->writeFieldBegin('setting', TType::LST, 1);
      {
        ...
        {
          foreach ($this->setting as $iter719)
          {
